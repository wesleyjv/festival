                    ...
                    <div class="filter-grid">
                        <div class="filter-group">
                            ...
                            <div class="filter-buttons">
                                ...
                                <button class="filter-btn <?php echo ($_GET['date'] ?? '') === '2026-07-23' ? 'active' : ''; ?>" onclick="window.location.href='/events/stories?date=2026-07-23'">Thursday</button>
                                <button class="filter-btn <?php echo ($_GET['date'] ?? '') === '2026-07-24' ? 'active' : ''; ?>" onclick="window.location.href='/events/stories?date=2026-07-24'">Friday</button>
                                <button class="filter-btn <?php echo ($_GET['date'] ?? '') === '2026-07-25' ? 'active' : ''; ?>" onclick="window.location.href='/events/stories?date=2026-07-25'">Saturday</button>
                                <button class="filter-btn <?php echo ($_GET['date'] ?? '') === '2026-07-26' ? 'active' : ''; ?>" onclick="window.location.href='/events/stories?date=2026-07-26'">Sunday</button>
                            </div>
                        </div>
                        <div class="filter-group">
